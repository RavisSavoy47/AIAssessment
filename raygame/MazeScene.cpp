...
{	
	...
	/// <summary>
	/// its the full maze of the game where the Tiles are placed
	/// </summary>
	TileKey map[Maze::HEIGHT][Maze::WIDTH] = {
		{ w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w },
		{ w, g, _, _, _, _, _, _, _, _, _, _, _, s, s, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, w, w, _, s, s, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, w, _, _, _, _, _, _, _, _, _, _, w, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, w, _, _, w, _, _, _, _, _, _, _, w, _, w, w, w, _, w, _, w, _, w, w },
		{ w, _, _, _, _, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, _, _, w, _, w, _, w, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, s, s, s, w, w },
		{ w, _, _, w, w, _, _, _, _, _, _, _, w, _, _, w, _, _, _, _, _, _, w, s, s, s, w, w },
		{ w, _, _, _, _, _, _, _, w, w, _, _, _, s, s, _, _, _, w, w, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, w, w, _, _, _, s, s, _, _, _, w, w, _, _, _, _, _, _, _, w },
		{ w, _, w, _, _, _, _, _, _, _, _, _, w, _, _, w, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, s, s, _, w, w, _, w, w, _, _, _, _, _, _, _, _, _, _, w, w, _, w, w, _, w, w, w },
		{ w, s, s, _, w, w, _, _, _, _, _, w, _, _, _, _, w, _, _, _, _, _, w, w, _, w, w, w },
		{ w, s, s, _, _, _, _, _, _, _, _, w, s, s, s, s, w, _, _, _, _, _, _, _, _, w, w, w },
		{ w, _, _, _, _, _, _, w, w, _, _, w, _, _, _, _, w, _, _, w, w, _, _, _, _, _, _, w },
		{ w, _, w, _, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, _, _, _, w },
		{ w, _, w, _, w, _, _, _, _, _, _, _, _, w, w, _, _, _, _, _, _, w, _, w, _, w, _, w },
		{ w, _, w, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, _, _, _, w, _, w },
		{ w, s, s, s, _, _, w, _, _, _, w, w, _, _, _, _, w, w, _, _, _, w, _, _, s, s, s, w },
		{ w, s, s, s, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, s, s, s, w },
		{ w, _, _, _, _, _, _, w, w, _, _, _, w, w, w, w, _, _, _, _, w, w, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, s, s, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, w, w, _, _, _, _, _, _, _, _, s, s, _, _, _, _, _, _, _, _, w, w, _, _, w },
		{ w, _, _, s, s, _, _, _, _, _, w, w, w, _, _, w, w, w, w, _, _, _, _, s, s, _, _, w },
		{ w, _, _, s, s, _, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, s, s, _, _, w },
		{ w, _, _, w, w, _, w, _, w, _, _, _, _, _, _, _, _, _, _, w, _, _, _, w, w, _, _, w },
		{ w, _, _, w, w, _, _, _, w, _, w, w, _, _, _, _, w, w, _, w, _, w, _, w, w, _, _, w },
		{ w, _, _, w, w, _, _, _, w, _, _, _, _, w, w, _, _, _, _, w, _, _, _, w, w, _, _, w },
		{ w, _, _, _, _, _, w, _, s, s, _, _, _, _, _, _, _, _, s, s, _, w, _, _, _, _, _, w },
		{ w, _, _, _, _, _, w, _, s, s, _, _, _, p, _, _, _, _, s, s, _, w, _, _, _, _, _, w },
		{ w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w },
	};
